...
public static class ExtVector3
{
	...
	public static Vector3 CustomMoveTowardsAngleFromVector(Vector3 frm, Vector3 to, float turnSpd, float deltaTime, Vector3 axis)
	{
		...
		float resultAngle = CustomMoveTowardsAngle(frmAngle, toAngle, turnSpd * 16, deltaTime);
	...
	public static Vector3 TurnDirection(Vector3 frm, Vector3 to, float turnSpd, float deltaTime, Vector3 axis)
	{
	...
	public static Vector3 CustomControlledLerp (Vector3 frm, Vector3 to, float lerpSpeed, float min, float max, float deltaTime)
	{
	...
	public static Vector3 FlattenPosition(Vector3 v)
	{
		Vector3 r = v;
		r.y = 0;
		return r;
